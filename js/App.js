...
!function (e) {
  ...
  function s(l) {
    ...
    return e[l].call(i.exports, i, i.exports, s), i.l = !0, i.exports;
  }

  s.m = e, s.c = t, s.d = function (e, t, l) {
  ...
  e.exports = function e(t, s, i) {
    ...
    for (var n = "function" == typeof l && l, r = 0; r < i.length; r++) {
      o(i[r]);
    }
    ...
    1: [function (e, t, s) {
      !function (e, t) {
        if (void 0 !== s) t(s);else {
          ...
          t(l.exports), e.lgUtils = l.exports;
        }
      }(this, function (e) {
        "use strict";
        ...
        var t = {
          ...
          on: function on(e, s, l) {
            var i = this;
            e && s.split(" ").forEach(function (s) {
              var o = i.getAttribute(e, "lg-event-uid") || "";
              t.Listener.uid++, o += "&" + t.Listener.uid, i.setAttribute(e, "lg-event-uid", o), t.Listener[s + t.Listener.uid] = l, e.addEventListener(s.split(".")[0], l, !1);
            });
          },
          off: function off(e, s) {
            if (e) {
              var l = this.getAttribute(e, "lg-event-uid");
                ...
                for (var i = 0; i < l.length; i++) {
                  if (l[i]) {
                    ...
                    if ("." === o.substring(0, 1)) for (var n in t.Listener) {
                      t.Listener.hasOwnProperty(n) && n.split(".").indexOf(o.split(".")[1]) > -1 && (e.removeEventListener(n.split(".")[0], t.Listener[n]), this.setAttribute(e, "lg-event-uid", this.getAttribute(e, "lg-event-uid").replace("&" + l[i], "")), delete t.Listener[n]);
                    } else e.removeEventListener(o.split(".")[0], t.Listener[o]), this.setAttribute(e, "lg-event-uid", this.getAttribute(e, "lg-event-uid").replace("&" + l[i], "")), delete t.Listener[o];
                  }
                }
              }
            }
    ...
    2: [function (e, t, s) {
      ...
      l = this, i = function i(e) {
        ...
        function o(e, t) {
          if (this.el = e, this.s = l({}, i, t), this.s.dynamic && "undefined" !== this.s.dynamicEl && this.s.dynamicEl.constructor === Array && !this.s.dynamicEl.length) throw "When using dynamic mode, you must also define dynamicEl as an Array.";
        ...
        o.prototype.init = function () {
          ...
          if (t.indexOf("lg=" + this.s.galleryId) > 0 && (e.index = parseInt(t.split("&slide=")[1], 10), s.default.addClass(document.body, "lg-from-hash"), s.default.hasClass(document.body, "lg-on") || (s.default.addClass(document.body, "lg-on"), setTimeout(function () {
            ...
            e.build(e.index);
          }));else for (var l = 0; l < e.items.length; l++) {
            !function (t) {
              s.default.on(e.items[t], "click.lgcustom", function (l) {
                l.preventDefault(), s.default.trigger(e.el, "onBeforeOpen"), e.index = e.s.index || t, s.default.hasClass(document.body, "lg-on") || (e.build(e.index), s.default.addClass(document.body, "lg-on"));
              });
            }(l);
          }
          ...
          for (var l in t.structure(), window.lgModules) {
          ...
          for (document.body.insertAdjacentHTML("beforeend", '<div class="lg-backdrop"></div>'), s.default.setVendor(document.querySelector(".lg-backdrop"), "TransitionDuration", this.s.backdropDuration + "ms"), i = 0; i < this.items.length; i++) {
            t += '<div class="lg-item"></div>';
          }

          if (this.s.controls && this.items.length > 1 && (l = '<div class="lg-actions"><div class="lg-prev" data-mouse-title="Назад">' + this.s.prevHtml + '</div><div class="lg-next" data-mouse-title="Вперед">' + this.s.nextHtml + "</div></div>"), ".lg-sub-html" === this.s.appendSubHtmlTo && (o = '<div class="lg-sub-html"></div>'), e = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + t + '</div><div class="lg-toolbar group"><span class="lg-close lg-icon"></span></div>' + l + o + "</div></div>", document.body.insertAdjacentHTML("beforeend", e), this.outer = document.querySelector(".lg-outer"), this.___slide = this.outer.querySelectorAll(".lg-item"), this.s.useLeft ? (s.default.addClass(this.outer, "lg-use-left"), this.s.mode = "lg-slide") : s.default.addClass(this.outer, "lg-use-css3"), n.setTop(), s.default.on(window, "resize.lg orientationchange.lg", function () {
            setTimeout(function () {
              n.setTop();
            }, 100);
          ...
          if (this.s.dynamic ? l = this.s.dynamicEl[e].subHtml : (t = this.items[e], l = t.getAttribute("data-sub-html"), this.s.getCaptionFromTitleOrAlt && !l && (l = t.getAttribute("title")) && t.querySelector("img") && (l = t.querySelector("img").getAttribute("alt"))), null != l) {
            var i = l.substring(0, 1);
            "." !== i && "#" !== i || (l = this.s.subHtmlSelectorRelative && !this.s.dynamic ? t.querySelector(l).innerHTML : document.querySelector(l).innerHTML);
          } else l = "";
        ...
        }, o.prototype.loadContent = function (e, t, l) {
          var i,
              o,
              n,
              r,
          ...
          if (!s.default.hasClass(u.___slide[e], "lg-loaded")) {
            ...
            if (s.default.trigger(u.el, "onAferAppendSlide", {
              index: e
            }), i = u.___slide[e].querySelector(".lg-object"), a && i.setAttribute("sizes", a), r) {
          ...
          s.default.on(u.___slide[e].querySelector(".lg-object"), "load.lg error.lg", function () {
            var t = 0;
            l && !s.default.hasClass(document.body, "lg-from-hash") && (t = l), setTimeout(function () {
        ...
        }, o.prototype.slide = function (e, t, l) {
          ...
          if (!n.lGalleryOn || i !== e) {
            ...
            if (!n.lgBusy) {
              ...
              if (this.s.download && ((c = n.s.dynamic ? !1 !== n.s.dynamicEl[e].downloadUrl && (n.s.dynamicEl[e].downloadUrl || n.s.dynamicEl[e].src) : "false" !== n.items[e].getAttribute("data-download-url") && (n.items[e].getAttribute("data-download-url") || n.items[e].getAttribute("href") || n.items[e].getAttribute("data-src"))) ? (document.getElementById("lg-download").setAttribute("href", c), s.default.removeClass(n.outer, "lg-hide-download")) : s.default.addClass(n.outer, "lg-hide-download")), s.default.trigger(n.el, "onBeforeSlide", {
                ...
                e < i ? (u = !0, 0 !== e || i !== r - 1 || l || (u = !1, d = !0)) : e > i && (d = !0, e !== r - 1 || 0 !== i || l || (u = !0, d = !1)), u ? (s.default.addClass(this.___slide[e], "lg-prev-slide"), s.default.addClass(this.___slide[i], "lg-next-slide")) : d && (s.default.addClass(this.___slide[e], "lg-next-slide"), s.default.addClass(this.___slide[i], "lg-prev-slide")), setTimeout(function () {
          ...
          if (!this.s.loop && this.s.hideControlOnEnd) {
            ...
            e + 1 < this.___slide.length ? (t.removeAttribute("disabled"), s.default.removeClass(t, "disabled")) : (t.setAttribute("disabled", "disabled"), s.default.addClass(t, "disabled")), e > 0 ? (l.removeAttribute("disabled"), s.default.removeClass(l, "disabled")) : (l.setAttribute("disabled", "disabled"), s.default.addClass(l, "disabled"));
          }
        }, o.prototype.setTranslate = function (e, t, l) {
          this.s.useLeft ? e.style.left = t : s.default.setVendor(e, "Transform", "translate3d(" + t + "px, " + l + "px, 0px)");
          ...
          if (e.s.enableSwipe && e.isTouch && e.doCss()) {
            for (var o = 0; o < e.___slide.length; o++) {
              s.default.on(e.___slide[o], "touchstart.lg", function (l) {
                s.default.hasClass(e.outer, "lg-zoomed") || e.lgBusy || (l.preventDefault(), e.manageSwipeClass(), t = l.targetTouches[0].pageX);
              });
            }

            for (var n = 0; n < e.___slide.length; n++) {
              s.default.on(e.___slide[n], "touchmove.lg", function (o) {
                s.default.hasClass(e.outer, "lg-zoomed") || (o.preventDefault(), l = o.targetTouches[0].pageX, e.touchMove(t, l), i = !0);
              });
            }

            for (var r = 0; r < e.___slide.length; r++) {
              s.default.on(e.___slide[r], "touchend.lg", function () {
                s.default.hasClass(e.outer, "lg-zoomed") || (i ? (i = !1, e.touchEnd(l - t)) : s.default.trigger(e.el, "onSlideClick"));
              });
            }
          }
          ...
          if (e.s.enableDrag && !e.isTouch && e.doCss()) {
            for (var n = 0; n < e.___slide.length; n++) {
              s.default.on(e.___slide[n], "mousedown.lg", function (l) {
                s.default.hasClass(e.outer, "lg-zoomed") || (s.default.hasClass(l.target, "lg-object") || s.default.hasClass(l.target, "lg-video-play")) && (l.preventDefault(), e.lgBusy || (e.manageSwipeClass(), t = l.pageX, i = !0, e.outer.scrollLeft += 1, e.outer.scrollLeft -= 1, s.default.removeClass(e.outer, "lg-grab"), s.default.addClass(e.outer, "lg-grabbing"), s.default.trigger(e.el, "onDragstart")));
              });
            }

            s.default.on(window, "mousemove.lg", function (n) {
              i && (o = !0, l = n.pageX, e.touchMove(t, l), s.default.trigger(e.el, "onDragmove"));
            }), s.default.on(window, "mouseup.lg", function (n) {
              o ? (o = !1, e.touchEnd(l - t), s.default.trigger(e.el, "onDragend")) : (s.default.hasClass(n.target, "lg-object") || s.default.hasClass(n.target, "lg-video-play")) && s.default.trigger(e.el, "onSlideClick"), i && (i = !1, s.default.removeClass(e.outer, "lg-grabbing"), s.default.addClass(e.outer, "lg-grab"));
            });
          }
          ...
          for (var i = 0; i < this.___slide.length; i++) {
            s.default.removeClass(this.___slide[i], "lg-next-slide"), s.default.removeClass(this.___slide[i], "lg-prev-slide");
          }
          ...
          }), s.default.on(e.outer, "mouseup.lg", function (l) {
            (s.default.hasClass(l.target, "lg-outer") || s.default.hasClass(l.target, "lg-item") || s.default.hasClass(l.target, "lg-img-wrap") && t) && (s.default.hasClass(e.outer, "lg-dragging") || e.destroy());
          }));
          ...
          if (e || s.default.trigger(t.el, "onBeforeClose"), document.body.scrollTop = t.prevScrollTop, document.documentElement.scrollTop = t.prevScrollTop, e) {
            if (!t.s.dynamic) for (var l = 0; l < this.items.length; l++) {
  ...
  var l = document.getElementsByClassName("js-hook");
  ...
  }, i.resolve = o, e.exports = i, i.id = 3;
}, function (e, t, s) {
  var l, i;
  l = [s(1), s(0)], void 0 === (i = function (e, t) {
    return (
      /*#__PURE__*/
      function (_t) {
  ...
  var l, i;
  l = [s(0), s(8)], void 0 === (i = function (e, t) {
    return (
      /*#__PURE__*/
      function (_e3) {
    ...
    function () {
      ...
      _createClass(_class6, [{
        ...
        value: function throttle(e, t) {
          ...
          var l = !1;
          return function () {
            l || (e.apply(s, arguments), l = !0, setTimeout(function () {
              l = !1;
            }, t));
          };
        }
      ...
      function (_e5) {
        ...
        _createClass(_class8, [{
          ...
          value: function getScrollStyle() {
            ...
            l.innerHTML = "body.lg-on { padding-right: ".concat(s, "px }"), document.body.appendChild(l);
          }
        }, {
          key: "hideAll",
